...
<?php almd_header( get_the_title(), get_field('banner'), 'equipe_index', get_field('logo') ) ?>
...
<?php $menu_array = wp_get_nav_menu_items('menu-news'); ?>
	<div class="row text-center padding">
		<div class="col-12">
			<ul>
				<li> <a id="todos" onclick="get_posts('todos')">Todos </a></li>
				<li> <a id="andrealmeida" onclick="get_posts('andrealmeida')">André de Almeida </a></li>
