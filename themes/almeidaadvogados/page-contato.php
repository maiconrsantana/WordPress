    ...
    <?php if($locations){ ?>
        ...
        <div class="row addresses-header">
            ...
            <?php foreach($locations as $lts){ ?>
                <div class="col-md-3 col-md-5-custom text-center no-padding"> <strong><?php echo $lts['abreviacao'] ?></strong> &nbsp; | &nbsp; <?php echo $lts['telefone'] ?> </div>
            <?php }?>
...
<?php echo do_shortcode( '[mrs_contact template="template_2"]' ); ?>
