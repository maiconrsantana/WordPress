    ...
    <div class="row padding">
        ...
        <div class="col-xl-6">
        	...
        	<form id="form_contato" action="<?php echo site_url()?>/wp-admin/admin-ajax.php" method="post" class="scrool-line form_contato">
              ...
              <div class="input_box">
                <input type="number" placeholder="Phone" name="telefone" required/>
              </div>

              <div class="input_box full">
                <input type="text" placeholder="Subject" name="assunto" required/>
              </div>

              <div class="input_box full">
                <textarea placeholder="Message" name="mensagem" required></textarea>
              </div>
              ...
              <div class="input_box send">
                <label class="check">
                  <input type="checkbox" name="news" value="1" checked />
                    I want to receive emails about Almeida Advogados
                </label>
              </div>
