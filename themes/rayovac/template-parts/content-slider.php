...
<div class="slider container">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <?php $i=1; foreach( $posts as $post ){ ?>
            <div class="item <?php if($i==1){?>active<?php }?>">
                ...
                <div class="main bs-slider-overlay"></div>
    ...
    <?php if(count($posts) > 1){ ?>
        ...
        <a class="left carousel-control" href="#bootstrap-touch-slider" role="button" data-slide="prev">
            <span class="glyphicon" aria-hidden="true"><img src="<?php echo get_template_directory_uri().'/files/img/arrow_left.png'; ?>"></span>
            <span class="sr-only">Previous</span>
        </a>
    
        <!-- Right Control -->
        <a class="right carousel-control" href="#bootstrap-touch-slider" role="button" data-slide="next">
            <span class="glyphicon" aria-hidden="true"><img src="<?php echo get_template_directory_uri().'/files/img/arrow_right.png'; ?>"></span>
